...
import { 
  Zap, Mail, Lock, ArrowRight, Loader2, User, Building2, Briefcase, BarChart3
} from "lucide-react";
           ...
           <form onSubmit={handleSignup} className="space-y-5">
              ...
              <div className="grid grid-cols-2 gap-4">
                 <div className="space-y-1.5">
                    ...
                    <div className="relative group">
                       ...
                       <input type="text" placeholder="Sarah" className="w-full bg-white border border-slate-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 rounded-xl pl-11 pr-4 py-3 text-sm font-bold text-slate-900 outline-none transition-all placeholder:text-slate-400 shadow-sm hover:border-slate-300" />
                    </div>
                 </div>
                 <div className="space-y-1.5">
                    <label className="text-xs font-bold text-slate-600 ml-1 uppercase tracking-wide">Last Name</label>
                    <div className="relative group">
                       <input type="text" placeholder="Chen" className="w-full bg-white border border-slate-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 rounded-xl px-4 py-3 text-sm font-bold text-slate-900 outline-none transition-all placeholder:text-slate-400 shadow-sm hover:border-slate-300" />
                    </div>
                 </div>
              </div>
              ...
              <div className="space-y-1.5">
                 ...
                 <div className="relative group">
                    ...
                    <input type="text" placeholder="Helix Market Research" className="w-full bg-white border border-slate-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 rounded-xl pl-11 pr-4 py-3 text-sm font-bold text-slate-900 outline-none transition-all placeholder:text-slate-400 shadow-sm hover:border-slate-300" />
                 </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                 <div className="space-y-1.5">
                    ...
                    <div className="relative group">
                       <Briefcase className="absolute left-3.5 top-3.5 w-5 h-5 text-slate-400 group-focus-within:text-orange-500 transition-colors pointer-events-none z-10" />
                       <select className="w-full bg-white border border-slate-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 rounded-xl pl-11 pr-8 py-3 text-sm font-bold text-slate-900 outline-none transition-all appearance-none cursor-pointer shadow-sm hover:border-slate-300 text-slate-600 font-medium">
                 ...
                 <div className="space-y-1.5">
                    <label className="text-xs font-bold text-slate-600 ml-1 uppercase tracking-wide">Data Focus</label>
                    <div className="relative group">
                       <BarChart3 className="absolute left-3.5 top-3.5 w-5 h-5 text-slate-400 group-focus-within:text-orange-500 transition-colors pointer-events-none z-10" />
                       <select className="w-full bg-white border border-slate-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 rounded-xl pl-11 pr-8 py-3 text-sm font-bold text-slate-900 outline-none transition-all appearance-none cursor-pointer shadow-sm hover:border-slate-300 text-slate-600 font-medium">
                          <option>Pricing</option>
                          <option>Sentiment</option>
                          <option>SEO/SERP</option>
              ...
              <div className="space-y-1.5">
                 ...
                 <div className="relative group">
                    ...
                    <input type="email" placeholder="sarah@helix.io" className="w-full bg-white border border-slate-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 rounded-xl pl-11 pr-4 py-3 text-sm font-bold text-slate-900 outline-none transition-all placeholder:text-slate-400 shadow-sm hover:border-slate-300" />
                 </div>
              </div>
              ...
              <div className="space-y-1.5">
                 ...
                 <div className="relative group">
                    ...
                    <input type="password" placeholder="••••••••" className="w-full bg-white border border-slate-200 focus:border-orange-500 focus:ring-4 focus:ring-orange-500/10 rounded-xl pl-11 pr-4 py-3 text-sm font-bold text-slate-900 outline-none transition-all placeholder:text-slate-400 shadow-sm hover:border-slate-300" />
                 </div>
              </div>
