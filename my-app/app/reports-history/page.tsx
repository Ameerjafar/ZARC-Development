...
const MOCK_REPORTS: Report[] = [
  ...
  {
    id: "3",
    title: "Fintech Competitive Intel",
    industry: "Fintech",
  ...
  {
    id: "5",
    title: "Solar Energy Trends 2026",
    industry: "Energy",
        ...
        >
          ...
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 bg-transparent border-none text-gray-900 placeholder:text-gray-400 focus:ring-0 outline-none"
            />
          </div>
          ...
          <div className="flex items-center gap-3 px-2">
            ...
            <div className="relative">
              <select
                ...
                className="pl-4 pr-10 py-2.5 bg-gray-50 hover:bg-gray-100 rounded-xl text-sm font-medium text-gray-700 appearance-none outline-none focus:ring-2 focus:ring-orange-500/20 cursor-pointer transition-colors"
              >
                {industries.map((ind) => (
            ...
            <button
              ...
              className="p-2.5 bg-gray-50 hover:bg-gray-100 rounded-xl text-gray-600 transition-colors flex items-center gap-2 text-sm font-medium"
            >
            ...
            >
              {filteredReports.map((report) => (
                <motion.div
                  ...
                  className={`group bg-white border border-gray-100 rounded-2xl p-5 hover:shadow-xl hover:shadow-orange-500/5 hover:border-orange-100 transition-all duration-300 ${
                    viewMode === "list" ? "flex items-center gap-6" : "flex flex-col"
                  }`}
                >
                  {/* Icon Area */}
                  <div className={`flex-shrink-0 w-12 h-12 rounded-xl flex items-center justify-center transition-colors ${
                     viewMode === "grid" ? "mb-4 bg-orange-50 group-hover:bg-orange-500" : "bg-orange-50 group-hover:bg-orange-500"
                  }`}>
                    <FileText className={`w-6 h-6 transition-colors ${
                      viewMode === "grid" ? "text-orange-500 group-hover:text-white" : "text-orange-500 group-hover:text-white"
                    }`} />
                  </div>
