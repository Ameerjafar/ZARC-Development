    ...
    <div className="relative min-h-screen bg-[#FAFAFA] text-slate-900 overflow-hidden font-sans selection:bg-orange-100 selection:text-orange-900">
      ...
      <main className="relative pt-32 pb-20 px-6 max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          {/* Headline (Vibrant Orange Gradient) */}
        ...
        <div className="relative z-10 hidden lg:block perspective-2000">
           <TiltCard>
             ...
             <motion.div 
               style={{ y: y2 }}
               className="absolute inset-0 bg-white rounded-2xl shadow-2xl shadow-orange-500/10 border border-slate-200 overflow-hidden flex flex-col"
             >
               {/* Mockup Header */}
               ...
               <div className="flex-1 p-6 bg-slate-50/30 flex gap-6">
                 ...
                 <div className="flex-1 space-y-6">
                   ...
                   <div className="grid grid-cols-2 gap-4">
                     ...
                     {/* Card 2: Your Growth (Orange Line) */}
                     <div className="bg-white p-4 rounded-xl border border-slate-100 shadow-sm space-y-3">
                       <div className="flex items-center gap-2 mb-2">
      ...
      <div className="w-full border-y border-slate-200 bg-white py-8 overflow-hidden relative">
          ...
          <div className="flex w-max animate-marquee gap-16 px-8 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            {[1,2,3,4,5,6,1,2,3,4].map((i, idx) => (
               <div key={idx} className="flex items-center gap-2 font-bold text-xl text-slate-400 hover:text-orange-500 transition-colors cursor-pointer">
